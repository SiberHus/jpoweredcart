...
public class OrderStatusRowMapper extends ObjectFactoryRowMapper<OrderStatus> {
	...
	@Override
	public OrderStatus mapRow(ResultSet rs, OrderStatus object) throws SQLException {
		...
		object.setId(rs.getInt("order_status_id"));
